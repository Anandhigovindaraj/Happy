"""
Django settings for santhosa_explorer project.
...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-t^c!kyyoy-!*6e!kwa4iri!a94d-^8o^g$6w&0-8lga!=zv5b#')
...
SITE_ID = 1  # Add this to your settings

# Configure Allauth for email-based login:
...
# Add AccountMiddleware to MIDDLEWARE
MIDDLEWARE = [
...
ROOT_URLCONF = 'santosha_explorer.urls'
...
WSGI_APPLICATION = 'santosha_explorer.wsgi.application'
